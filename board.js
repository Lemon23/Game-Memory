...
var Board = React.createClass({
        ...
        if (this.state.tileStates[index] === 'unturned') {
            ...
            if (this.flippedTile === undefined) {
                ...
                this.setState({
                    ...
                    tileStates: _.extend(this.state.tileStates, _.zipObject([index], ['revealed']))
                });
            } else {
                ...
                if (matched) {
                    ...
                    this.setState({
                        ...
                        tileStates: _.extend(this.state.tileStates,
                            _.zipObject([index, otherIndex], ['correct', 'correct']))
                    });
                } else {
                    ...
                    this.setState({
                        ...
                        tileStates: _.extend(this.state.tileStates,
                            _.zipObject([index, otherIndex], ['wrong', 'wrong']))
                    });
                }
                // 删除保存的信息
                    ...
                    if (this.isMounted()) {
                        ...
                        this.setState({
                            ...
                            tileStates: matched ? this.state.tileStates : _.extend(this.state.tileStates,
                                _.zipObject([index, otherIndex], ['unturned', 'unturned']))
                        });
                    }
                }.bind(this), 1500);
            }
    ...
    render: function () {
        ...
        return (
            <div>
                <button className='btn btn-default' onClick={this.props.onEndGame}>End</button>
